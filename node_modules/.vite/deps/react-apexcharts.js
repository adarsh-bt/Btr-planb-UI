  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var j = function() {
      ...
      return r(t2, [{ key: "drawGridArea", value: function() {
        ...
        if (!e2.isBarHorizontal || this.isRangeBar) {
          var o2, n2, l2;
          if (s2 = this.xaxisLabels.length, this.isRangeBar) s2--, r2 = e2.labels.length, t3.config.xaxis.tickAmount && t3.config.xaxis.labels.formatter && (s2 = t3.config.xaxis.tickAmount), (null === (o2 = e2.yAxisScale) || void 0 === o2 || null === (n2 = o2[a2]) || void 0 === n2 || null === (l2 = n2.result) || void 0 === l2 ? void 0 : l2.length) > 0 && "datetime" !== t3.config.xaxis.type && (s2 = e2.yAxisScale[a2].result.length - 1);
    ...
    var Ft = function() {
      ...
      return r(t2, [{ key: "draw", value: function(t3, i2, a2, s2) {
        ...
        }), o2.config.chart.stacked) for (var R2 = d2.length; R2 > 0; R2--) h2.add(d2[R2 - 1]);
        ...
        for (var O2, N2 = 0, W2 = 0; W2 < o2; W2++) {
          ...
          if (H2) if (h2 > 0 && L2.globals.collapsedSeries.length < L2.config.series.length - 1) {
            y2 = this.prevSeriesY[function(t4) {
              for (var e3 = t4, i3 = 0; i3 < L2.globals.series.length; i3++) if (L2.globals.collapsedSeriesIndices.indexOf(t4) > -1) {
                e3--;
                break;
              }
              return e3 >= 0 ? e3 : 0;
