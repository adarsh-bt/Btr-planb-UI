...
function Earas_menus() {
  ...
  const role = userRoleMapping[usernameVal] || tokenRole;
        ...
        <MainCard title="">
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} sm={6} md={4} lg={3}>
              <Card
                component={Link}
                to="/schemes/earas/inspection_reports"
                sx={{
                  textDecoration: 'none',
                  display: 'flex',
                  flexDirection: { xs: 'column', sm: 'row' },
            ...
            {['District Level Approver', 'Super Admin', 'IT Admin', 'EARAS Admin', 'Area Estimator', 'Area Estimation Verifier 1', 'Area Estimation Verifier 2', 'Area Estimation Verifier 3', 'Approver 2'].includes(role) && (
              <Grid item xs={12} sm={6} md={4} lg={3}>
                <Card
                  component={Link}
                  to="/schemes/earas/area-estimation"
                  sx={{
                    textDecoration: 'none',
                    display: 'flex',
                    flexDirection: { xs: 'column', sm: 'row' },
