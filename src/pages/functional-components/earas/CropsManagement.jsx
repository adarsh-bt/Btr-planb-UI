...
const [validationErrors, setValidationErrors] = useState({
  ...
  const fetchAllCrops = async () => {
    try {
      setLoading(true);
      const url = `http://localhost:9114/earas-form1-entry/api/master-crop/fetch-all?page=0&size=1000`;
...
const validateTextFieldLength = (text, maxLength = 100) => {
  ...
  const fetchUnits = async () => {
    try {
      ...
      const response = await axios.get("http://localhost:9114/earas-form1-entry/api/master-unit/fetch-all");
      const data = response.data;
  ...
  const fetchStandsData = async () => {
    try {
      ...
      const response = await axios.get("http://localhost:9114/earas-form1-entry/api/master-stands-per-hectare/fetch-all");
      const data = response.data;
...
const fetchIrrigationData = async () => {
  try {
    ...
    const response = await axios.get("http://localhost:9114/earas-form1-entry/irrigation-details/fetch-all-sources");
    const data = response.data;
...
const fetchCceCrops = async () => {
  try {
    setCceLoading(true);
    const response = await axios.get("http://localhost:9114/earas-form1-entry/cce-crop-details/master-cce-crops/fetch-all");
    const data = response.data;
...
const fetchFrames = async () => {
  try {
    ...
    const response = await axios.get("http://localhost:9114/earas-form1-entry/api/master-frame/fetch-all");
    const data = response.data;
...
const normalizeActiveStatus = (status) => {
  ...
  const fetchCropGroups = async () => {
    try {
      ...
      const response = await axios.get("http://localhost:9114/earas-form1-entry/api/master-crop-group/fetch-all");
      const data = response.data;
  ...
  const fetchCropTypes = async () => {
    try {
      ...
      const response = await axios.get("http://localhost:9114/earas-form1-entry/api/master-crop-type/fetch-all");
      const data = response.data;
  ...
  const fetchDistricts = async () => {
    try {
      ...
      const response = await axios.get("http://localhost:9114/earas-form1-entry/api/master-district/fetch-all");
      const data = response.data;
  ...
  const handleSaveNewCrop = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:9114/earas-form1-entry/api/master-crop/add", {
  ...
  const handleSaveUnit = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:9114/earas-form1-entry/api/master-unit/add", unitFormData);
  ...
  const handleSaveStands = async () => {
    ...
    try {
      const response = await axios.post("http://localhost:9114/earas-form1-entry/api/master-stands-per-hectare/add", standsFormData);
  ...
  try {
    ...
    const response = await axios.post("http://localhost:9114/earas-form1-entry/irrigation-details/master-irrigation-source/add", payload);
...
const handleSaveCce = async () => {
  ...
  try {
    ...
    const response = await axios.post("http://localhost:9114/earas-form1-entry/cce-crop-details/master-cce-crop/add", payload);
