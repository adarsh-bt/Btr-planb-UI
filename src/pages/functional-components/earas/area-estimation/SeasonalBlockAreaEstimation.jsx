...
const SeasonalBlockAreaEstimation = () => {
  ...
  const handleExportExcel = () => {
    ...
    const filename = `Seasonal_Block_${blockId}_Area_Estimation_${year}_${season}_${dateStr}_${timeStr}.xls`;
    ...
    const metadataRows = [
      ['Report Name', 'Seasonal Block Level Area Estimation'],
    ...
    exportToExcelMultiSheet(filename, 'Block Seasonal Estimation', headers, dataRows, metadataRows);
  };
    ...
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Typography variant="h3" fontWeight={700} sx={{ color: '#04255e' }}>
          Seasonal Crop Estimation - Block Level (Block ID: {blockId}, {season} Season)
        </Typography>
      ...
      <Grid item xs={12}>
        <MainCard
          title="Panchayat-wise Crop Area Contribution"
          secondary={
...
export default SeasonalBlockAreaEstimation;
