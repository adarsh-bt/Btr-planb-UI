...
const SeasonalPanchayatAreaEstimation = () => {
  ...
  const handleExportExcel = () => {
    ...
    const filename = `Seasonal_Panchayat_${panchayatId}_Area_Estimation_${year}_${season}_${dateStr}_${timeStr}.xls`;
    ...
    const metadataRows = [
      ['Report Name', 'Seasonal Panchayat Level Area Estimation'],
    ...
    exportToExcelMultiSheet(filename, 'Panchayat Seasonal Estimation', headers, dataRows, metadataRows);
  };
    ...
    <Grid container spacing={3}>
      ...
      <Grid item xs={12} sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
        <Typography variant="h3" fontWeight={700} sx={{ color: '#04255e' }}>
          Seasonal Crop Estimation - Panchayat Level (Panchayat ID: {panchayatId}, {season} Season)
        </Typography>
            ...
            <Card sx={{ bgcolor: '#04255e', color: 'white', borderRadius: 3 }}>
              <CardContent>
                ...
                <Typography variant="h2" fontWeight={700} sx={{ mt: 1 }}>
                  {totalCropTotalArea.toLocaleString()} Ha
                </Typography>
          ...
          <Grid item xs={12} sm={4}>
            <Card sx={{ bgcolor: '#1b5e20', color: 'white', borderRadius: 3 }}>
              <CardContent>
                ...
                <Typography variant="h2" fontWeight={700} sx={{ mt: 1 }}>
                  {totalCropIrrigated.toLocaleString()} Ha
                </Typography>
          ...
          <Grid item xs={12} sm={4}>
            <Card sx={{ bgcolor: '#e65100', color: 'white', borderRadius: 3 }}>
              <CardContent>
                ...
                <Typography variant="h2" fontWeight={700} sx={{ mt: 1 }}>
                  {totalCropUnirrigated.toLocaleString()} Ha
                </Typography>
      ...
      <Grid item xs={12}>
        <MainCard
          title="Zone-wise Crop Area Contribution"
          secondary={
                ...
                {filteredRowData.length > 0 ? (
                  ...
                  <TableRow>
                    <TableCell colSpan={6} align="center" sx={{ py: 3 }}>
                      No zone records found matching search filters.
                    </TableCell>
                  </TableRow>
                )}
                {/* Column Totals Row */}
...
export default SeasonalPanchayatAreaEstimation;
