  ...
  >
         <CardActionArea component={Link} to={item.url}>
          ...
          <Grid container spacing={4} sx={{ marginBottom: '3rem' }}>
            ...
            {["Super Admin", "District Level Approver", "IT Admin", "EARAS Admin", "Taluk Level Approver", "District Level Data Viewer", "Field Inspector", "Field Data Collector"].includes(authservice.getrole()) && (
              <Grid item xs={12} sm={4} md={4} lg={4}>
                <Card
                  component={Link}
                  to="/Report"
