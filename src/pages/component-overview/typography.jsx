                                            ...
                                            <Table>
                                                ...
                                                <TableBody>
                                                    ...
                                                    <TableRow>
                                                        ...
                                                        <TableCell><TextField fullWidth value={getZoneTotals('wet')} disabled /></TableCell>
                                                        <TableCell><TextField fullWidth value={getZoneTotals('dry')} disabled /></TableCell>
                                                        <TableCell><TextField fullWidth value={getZoneTotals('total')} disabled /></TableCell>
                                                    </TableRow>
                                                </TableBody>
                                            </Table>
                                        </TableContainer>
